            ...
            <Col md={12} key={job.id} className="mb-4">
              <Card className="applied-job-card h-100">
                <Card.Body>
                  ...
                  <Card.Text>
                    <FaBuilding className="me-2 icon-color" />
                    <strong className="color-gray-off">Company:</strong> {job.company_name}
                  </Card.Text>

                  <Card.Text>
                    <FaCalendarAlt className="me-2 icon-color" />
                    <strong className="color-gray-off">Applied On:</strong>{" "}
